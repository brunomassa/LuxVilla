 ...
 * Use the {@link separadoraveiro#newInstance} factory method to
 * create an instance of this fragment.
 */
public class separadoraveiro extends Fragment implements RecyclerViewOnClickListenerHack {
    ...
    public static separadoraveiro newInstance(String param1, String param2) {
        separadoraveiro fragment = new separadoraveiro();
        ...
        if (array!=null||array.length()>0){
            for (int i=0;i<array.length();i++){
                try {
                    ...
                    if (local.equalsIgnoreCase("Aveiro")){
    ...
    public static List<listasql> getdados(){
        ...
        for(int i=0;i<colunas;i++){
            ...
            if (locsqloffline.equalsIgnoreCase("Aveiro")){
