...
class separadortodas : Fragment(), RecyclerViewOnClickListenerHack {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        val view = inflater!!.inflate(R.layout.fragment_separadortodas, container, false)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): separadortodas {
            val fragment = separadortodas()
            val args = Bundle()
